...
<div className="flex lg:ml-2 lg:mt-2 gap-4">
        ...
        <div>
          ...
          <div className="mt-2 flex gap-2">
            <button onClick={()=>handleUnfriend(friend)} className="px-4 py-2 bg-purple-400 rounded-lg text-[#DADCE1] hover:text-[#d6d9e2] hover:bg-purple-500 hover:hover:ease-in-out duration-100 ">
              Unfriend
            </button>
            <button onClick={()=>handleBlock(friend)} className="px-4 py-2 bg-purple-400 rounded-lg text-[#DADCE1] hover:text-[#d6d9e2] hover:bg-purple-500 hover:hover:ease-in-out duration-100 ">
              Block
            </button>
          </div>
        </div>
